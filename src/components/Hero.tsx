...
const Hero = () => {
  const handleWhatsApp = () => {
    window.open("https://wa.me/8180895628?text=Hi! I'd like to order a surprise gift 🎁", "_blank");
  };
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={heroBg} alt="Surprise Gift Hamper" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20 pb-8">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-center text-foreground mb-6 leading-tight">
          We Plan the Surprise. <br />
          <span className="text-primary">You Take the Credit.</span>
        </h1>

        {/* Subheadline */}
        <p className="text-lg sm:text-xl text-muted-foreground text-center max-w-2xl mx-auto mb-8">
          Thoughtful hampers, flowers, and personalized surprises for every special moment.
          <span className="text-foreground font-medium"> Birthdays, anniversaries, proposals & more.</span>
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 text-sm text-muted-foreground">
          <span className="flex items-center gap-1">✅ 500+ Happy Moments</span>
